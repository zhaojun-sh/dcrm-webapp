...
Bitcoin.ECKey = (function () {
    ...
    */
    ...
    ECKey.prototype.mysignHex = function (hash) {
        return ECDSA.mysign(hash, this.priv);
    };

    ECKey.prototype.signHex = function (hash) {
        return Crypto.util.bytesToHex(this.sign(hash)).toString().toUpperCase();
    };
    ...
    ECKey.prototype.parseSig = function (sig) {
        return ECDSA.parseSig(sig);
    };

    ECKey.prototype.parseSigHex = function (sig) {
        var obj = ECDSA.parseSig(sig);
        obj.r = Crypto.util.bytesToHex(obj.r.toByteArrayUnsigned()).toString().toUpperCase();
        obj.s = Crypto.util.bytesToHex(obj.s.toByteArrayUnsigned()).toString().toUpperCase();
        return obj;
    };
